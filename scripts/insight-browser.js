(async()=>{
 ...
 const panel=()=>document.querySelector('[data-testid="safety-window"]'),map=()=>document.querySelector('[data-testid="safety-map"]');
 try{
  ...
  location.hash='#/carrier/3938496/safety';await wait(()=>panel());
