...
REQUIRED_FIELDS: dict[str, set[str]] = {
    ...
    "3uet-3z4i": {"usdot_number", "docket_number", "policy_no", "effective_date", "cancl_effective_date", "filing_status_reason", "insurance_company_name", "max_cov_amount"},
    ...
    "xe5s-wca7": {"usdot_number", "docket_number", "policy_no", "effective_date", "cancl_effective_date", "filing_status_reason", "insurance_company_name", "max_cov_amount"},
