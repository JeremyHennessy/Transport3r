...
export function SafetyWindowPanel({dot,registry}:{dot:string;registry:SchemaRegistry}) {
  ...
  async function apply() {
    ...
    try { const window=validateEventWindow({start,end});const loaded=await loadSafetyWindow(registry,dot,window);if(request===generation.current)setResult(loaded); }
